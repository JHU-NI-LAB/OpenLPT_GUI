...
tracks_code = table2array(...
    readtable('../../results/test_STB/ConvergeTrack/LongTrackActive_49.csv'));
tracks_code_inactive = table2array(...
    readtable('../../results/test_STB/ConvergeTrack/LongTrackInactive_49.csv'));
tracks_code_inactive(:,1) = tracks_code_inactive(:,1) + ...
                            size(unique(tracks_code(:,1)),1);
tracks_code = [tracks_code; tracks_code_inactive];
tracks_code_exit = table2array(...
    readtable('../../results/test_STB/ConvergeTrack/ExitTrack_49.csv'));
tracks_code_exit(:,1) = tracks_code_exit(:,1) + ...
                        size(unique(tracks_code(:,1)),1);
tracks_code = [tracks_code; tracks_code_exit];
...
%%
show_image = 0;
save_path = '../../results/test_STB/ConvergeTrack/Track_Quality.mat';
...
%%
tracksID_orig_notfind = find(fit_old(:,1) == 0)-1;
